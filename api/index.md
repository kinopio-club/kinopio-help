...
Method | Path | Request Body Keys | Description | Auth
--- | --- | --- | --- | ---
...
`GET`    | <code class="spaces">/space/:spaceId/removedCards</code> |  | Get cards removed in a space                                                         | `canEditSpace`
...
`PATCH`  | <code class="spaces">/space/collaborator</code>          | `collaboratorKey`, `spaceId`, `userId` | Adds the userId to the spaceId using the collaboratorKey specified in the request body | `spaceCollaboratorKey`
...
`DELETE` | <code class="spaces">/space/collaborator</code>          | `spaceId`, `userId` | Removes collaborator user from space                              | `canEditSpace`
