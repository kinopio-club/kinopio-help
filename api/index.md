...
`PATCH`   | <code class="cards">/card/list</code>                   | Use body `{id, listId}` to add a card id to specified list. The card's position and width will also be updated                                                                      | `canEditSpace`
`PATCH`   | <code class="cards">/card/restore</code>                | Restore removed card specified in body                                                                                                                                              | `canEditSpace`
`DELETE`  | <code class="cards">/card/list</code>                   | Remove card from list specified in body. The card's position will be shifted to the right of the list                                                                               | `canEditSpace`
