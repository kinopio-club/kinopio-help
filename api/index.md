...
<code class="users">panSpeedPercent</code>                  | `Integer`  | Panning speed when you hold and drag with the space key or right/middle mouse buttons. `100` is fastest/default
