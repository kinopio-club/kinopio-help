...
<code class="users">panSpeedPercent</code>                  | `Integer`  | Panning speed when you hold and drag with the space key or right/middle mouse buttons. `0` is 1:1/default, `100` is fastest
